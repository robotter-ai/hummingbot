...
class KillSwitchMode(BaseClientModel, ABC):
    @abstractmethod
    def get_kill_switch(self, hb: "HummingbotApplication") -> KillSwitch: ...  # noqa: E704
...
class TelegramMode(BaseClientModel, ABC):
    @abstractmethod
    def get_notifiers(self, hb: "HummingbotApplication") -> List[TelegramNotifier]: ...  # noqa: E704
...
class DBMode(BaseClientModel, ABC):
    @abstractmethod
    def get_url(self, db_path: str) -> str: ...  # noqa: E704
...
class RateSourceModeBase(BaseClientModel, ABC):
    @abstractmethod
    def build_rate_source(self) -> RateSourceBase: ...  # noqa: E704
